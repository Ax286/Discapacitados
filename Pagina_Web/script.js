...
//GRAFICA DE TIPO DE DISCAPACITADOS (HOMBRES)
function GraficaHTipo(datos){
    var ctx = document.getElementById('GraficaHTipo').getContext('2d');
    ...
    var opciones = {
        ...
        plugins: {
          ...
          title: {
            display: true,
            text: 'TIPO DE DISCAPACIDAD (HOMBRES)'
          }
        }
      }

    if (graficaHTipo) {
        graficaHTipo.data = datosGrafica;
        graficaHTipo.options = opciones;
        graficaHTipo.update();
    } else {
        graficaHTipo = new Chart(ctx, {
            type: 'doughnut',
            data: datosGrafica,
            options: opciones
        });
...
//GRAFICA TIPO DE DISCAPACITADO (MUJERES)
function GraficaMTipo(datos){
    var ctx = document.getElementById('GraficaMTipo').getContext('2d');
    ...
    var opciones = {
        ...
        plugins: {
            ...
            title: {
                display: true,
                text: 'TIPO DE DISCAPACIDAD (MUJERES)'
            }
        }
    };

    if (graficaMTipo) {
        graficaMTipo.data = datosGrafica;
        graficaMTipo.options = opciones;
        graficaMTipo.update();
    } else {
        graficaMTipo = new Chart(ctx, {
            type: 'doughnut',
            data: datosGrafica,
            options: opciones
        });
